...
CPP_COMPILE = 'g++ -std=c++17 -O2 -Wall -Wextra -Wshadow -Wformat=2 -Wfloat-equal -Wconversion -Wlogical-op -Wshift-overflow=2 -Wduplicated-cond -DLOCAL -D_GLIBCXX_DEBUG -Wl,--stack,268435456 -I C:/Users/Max/ac-library '
    ...
    for file in os.listdir(probDir):
        if file.endswith('.in'):
            ...
            if ext == 'cpp':
                ...
                os.system('python ' + name + '.py < ' + str(probDir / file) + ' > temp.out')
            else:
